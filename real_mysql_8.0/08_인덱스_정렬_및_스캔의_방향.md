...
### Unique index    
- InnoDB는 index key 저장 시 change buffer 활용 -> unique index 쓰기 시에는 중복여부 체크해야해 버퍼링 불가 -> 더 느리게 작동          
